    ...
    <div className="w-full max-w-md bg-white rounded-[2.5rem] p-8 shadow-xl border border-stone-100">
      ...
      <form onSubmit={handleEmailAuth} className="space-y-4 mb-6">
        <div>
          ...
          <input
            type="email"
            className="w-full bg-stone-50 border-none px-4 py-3.5 rounded-2xl outline-none focus:ring-2 focus:ring-stone-200 transition-all text-stone-800"
        ...
        <button
          type="submit"
          className="w-full bg-stone-800 text-white font-black py-4 rounded-2xl mt-4 active:scale-95 transition-all disabled:opacity-50 shadow-lg"
          disabled={loading}
        >
      ...
      <button
        ...
        type="button"
        disabled={loading}
        className="w-full bg-white border-2 border-stone-100 text-stone-800 font-bold py-3.5 rounded-2xl flex items-center justify-center gap-3 active:scale-95 transition-all hover:bg-stone-50 disabled:opacity-50"
      >
      ...
      <p className="mt-8 text-center text-sm font-medium text-stone-500">
        ...
        <button
          ...
          className="text-stone-800 font-bold underline underline-offset-4"
        >
          {isRegistering ? '登入' : '註冊'}
        </button>
      </p>
